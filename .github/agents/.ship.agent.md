...
| `backlogit_move_item` | Allowed — move members of Ship's current shipment through `active` / `done` execution status only |
| `backlogit_archive_item` | Allowed — single-artifact archival of manifest items during safe-close |
